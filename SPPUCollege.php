...
<a class="navbar-brand mr-1" href="index.php"><img src="images/logo.png" class="headederlogo" alt="Cinque Terre"></a>
  ...
  <div id="wrapper">
    ...
    <div class="card card-register1 mx-auto mt-12">
      <div class="card-header">SPPU College</div>
      <div class="card-body">
        <form>
          ...
          <div class="form-group">
		   ...
		   <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <div class="input-group">
                  <input type="text" id="firstName1" class="form-control" placeholder="Bill to be generated in the Name of" required="required" >  
                </div>
              </div>
