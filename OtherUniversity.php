...
<a class="navbar-brand mr-1" href="index.php"><img src="images/logo.png" class="headederlogo" alt="Cinque Terre"></a>
  ...
  <div id="wrapper">
    ...
    <div class="card card-register1 mx-auto mt-12">
      <div class="card-header">Other University</div>
      <div class="card-body">
        <form>
          <div class="form-group">
		   ...
		   <div class="form-group">
            ...
            <div class="form-row">
              <div class="col-md-6">
                <div class="input-group">
                  <input type="text" id="firstName1" class="form-control" placeholder="Name and Address of College " required="required" >
                </div>
              </div>
			  <div class="col-md-6">
                <div class="input-group">
                  <input type="text" id="lastName1" class="form-control" placeholder="Name of University" required="required">   
                </div>
              </div>
            </div>
          </div>
           <div class="form-group">
            <div class="form-row">
			  ...
			  <div class="col-md-6">
                <div class="input-group">
                  <input type="text" id="lastName1" class="form-control" placeholder="GST No." required="required">   
                </div>
              </div>
		  ...
		  <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <div class="input-group">
                  <input type="password" id="inputPassword" class="form-control" placeholder="Guide Email Address" required="required">  
                </div>
              </div>
              <div class="col-md-6">
                <div class="input-group">
				 <select name="stateslist" id="stateslist" class="form-control "/>
...
<option value="West Bengal">West Bengal</option>
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="input-group">
                  <input type="password" id="confirmPassword" class="form-control" placeholder="New Password" required="required">  
                </div>
              </div>
            </div>
          </div>
		   <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="input-group">
                  <input type="text" id="firstName1" class="form-control" placeholder="Confirm password" required="required" >  
                </div>
              </div>
            </div>
          </div>
